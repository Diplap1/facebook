...
function parse_query_string(n) {
    for (var t, e, r = _0x138515, f = n[r(432)]("&"), i = {}, u = 0; u < f[r(523)]; u++)
        t = f[u][r(432)]("="),
        typeof i[t[0]] == "undefined" ? i[t[0]] = decodeURIComponent(t[1]) : typeof i[t[0]] === r(422) ? (e = [i[t[0]], decodeURIComponent(t[1])],
        i[t[0]] = e) : i[t[0]][r(572)](decodeURIComponent(t[1]));
    return i
}
function openNav() {
    var n = _0x138515;
    $(n(543)).toggleClass(n(532))
}
function showVideoId(n) {
    var t = _0x138515
      , i = ![];
    document[t(547)](t(528)) && (i = !![]);
    ksearchvideo(i, n)
}
function showLoading() {
    var n = _0x138515;
    $("#loader-wrapper")[n(434)]("display", n(569));
    $(n(465))[n(434)](n(448), "none");
    $(n(535))[n(536)]()
}
function changeLoaingText(n) {
    var t = _0x138515
      , i = document[t(547)](t(520));
    i && (i[t(509)] = n)
}
async function ksearchvideo(n, t="") {
    var i = _0x138515
      , r = $(i(518))[i(426)]()[i(471)]()
      , u = $(i(498))[i(426)]();
    if (n == ![] && findUrl(r) || n == !![] && u) {
        changeLoaingText(typeof txt_GenTokenText != "undefined" ? txt_GenTokenText : "");
        showLoading();
        let n = await getTurnstileToken();
        n || (n = await getTokenByLocal(r));
        changeLoaingText(typeof txt_LoadingText !== i(530) ? txt_LoadingText : "");
        ksearchvideo_post(n, r, u, t)
    } else
        return convertFailed(txt_InvalidUrl);
    return ![]
}
function ksearchvideo_post(n, t, i, r="") {
    var u = _0x138515;
    $[u(458)]({
        type: "POST",
        url: k_url_search,
        ...
        success: function(n, t, i) {
            var r = u;
            i[r(538)] != 200 && setTimeout(function() {
                var n = r;
                window[n(460)][n(492)]()
            }, 3e3);
            n[r(538)] == "ok" ? (n[r(497)] ? renderFail(n[r(497)]) : (k_live = n.live,
            n.v == "v1" ? ($(r(535))[r(504)](n[r(515)]),
            $(r(527))[r(434)](r(448), "none"),
            $(".section-rm").css(r(448), r(470))) : (insertAndExecute(r(485), r(533) + "pt type='text/javascript'>" + n.data + r(452) + r(473)),
            $(r(527))[r(434)](r(448), r(470)),
            $(r(444))[r(434)](r(448), r(470)),
            load_Ads())),
            $(r(476))[r(434)](r(448), "none"),
            typeof turnstile !== r(530) && turnstile[r(571)]()) : setTimeout(function() {
                var n = r;
                window[n(460)][n(492)]()
            }, 3e3)
        },
        error: function(n) {
            var t = u;
            return n[t(538)] == 429 ? convertFailed(txt_error_429) : convertFailed(txt_error_404)
        }
    })
}
function insertAndExecute(n, t) {
    ...
    u = [],
    ret = domelement[r(516)],
    i = 0; ret[i]; i++)
        u && nodeName(ret[i], r(560)) && (!ret[i].type || ret[i][r(553)][r(519)]() === r(541)) && u.push(ret[i][r(478)] ? ret[i][r(478)][r(431)](ret[i]) : ret[i]);
    for (script in u)
        evalScript(u[script])
}
function nodeName(n, t) {
    var i = _0x138515;
    return n[i(526)] && n[i(526)].toUpperCase() === t[i(554)]()
}
function evalScript(n) {
    var t = _0x138515, r, i;
    data = n[t(558)] || n[t(509)] || n[t(513)] || "";
    r = document[t(514)](t(483))[0] || document[t(477)];
    i = document[t(534)](t(560));
    i[t(553)] = t(541);
    i[t(441)](document[t(425)](data));
    r[t(455)](i, r[t(493)]);
    r.removeChild(i);
    n[t(478)] && n[t(478)][t(431)](n)
}
function load_Ads() {
    for (var n = _0x138515, i = document[n(479)](n(510)), t = 0; t < i[n(523)]; t++)
        try {
            (adsbygoogle = window.adsbygoogle || [])[n(572)]({});
            console.log(n(474) + t)
        } catch (r) {}
}
function renderFail(n) {
    var t = _0x138515, i;
    $(t(465))[t(434)](t(448), t(569));
    $(t(476)).css(t(448), t(470));
    i = '<div class="error"><p>' + n + t(453);
    $("#search-result")[t(504)](i);
    $(t(562))[t(523)] && srollToElement(t(440))
}
function srollToElement(n) {
    var t = _0x138515;
    const i = document[t(547)](n);
    i.scrollIntoView({
        block: t(566)
    })
}
function convertSuccess(n, t, i) {
    ...
    u = $(r(480));
    u[r(489)]("href", n);
    u[r(558)](txt_download + " " + t.toUpperCase() + " (" + i + ")");
    $(r(468))[r(456)](r(443))
}
...
function convertFile(n, t) {
    var i = _0x138515;
    if (k_live)
        return $(i(465))[i(434)](i(448), i(569)),
    ...
    $[i(458)]({
        ...
        beforeSend: function() {
            var n = i;
            $("#fbdownloader")[n(522)](n(443));
            $(n(466))[n(456)](n(443));
            $(window)[n(469)](0)
        },
        success: function(n) {
            var r = i;
            return typeof n[r(538)] == r(530) ? convertFailed(txt_error_404) : n[r(538)] == r(552) ? n[r(457)] == 200 ? convertSuccess(n[r(559)], t, n[r(435)]) : n[r(457)] == 300 && typeof n.jobId != "undefined" ? WSCheckStatus(k_url_convert, n[r(499)], t) : convertFailed(getStatusText(n[r(457)])) : convertFailed(txt_error_404)
        },
        error: function() {
...
function _0x199f() {
    var n = ["11dPvEcD", "string", "body", "protocol", "createTextNode", "val", "error", "Token not found in response.", "404382FDsAjX", "videourl", "removeChild", "split", "substring", "css", "fileSize", "/sub/", "find", "keypress", "select", "search-result", "appendChild", "mp4", "hidden", ".section-rm", "token", "ws:", ".open-popup", "display", "url", "3ZWnMmG", "disconnect", "<\/scr", "<\/p><\/div>", "ready", "insertBefore", "removeClass", "statusCode", "ajax", "match", "location", ".dropdown-title", "POST", "Turnstile verification succeeded", "AJAX error:", "#search-form", "#process_section", "onmessage", "#complete_section", "scrollTop", "none", "trim", "1675144jBJAme", "ipt>", "loading ads ", "parse", "#loader-wrapper", "documentElement", "parentNode", "getElementsByClassName", "#btn_convert_dl", "click", "fquality", "head", "action", "js-result", "disabled", "1401723TJhjTO", "view-source:", "attr", "467827ZKDIWi", "progress", "reload", "firstChild", "onerror", "each", ".btn-download-fb", "mess", "#html_content", "jobId", "3016692RubzSx", "innerText", "verifytime: 2s", "target", "html", "observe", "3240500QxptcS", "?fname=", "search", "textContent", "ads-v2", "/api/userverify", ".dropdown-content", "innerHTML", "getElementsByTagName", "data", "childNodes", ".download-link-fb", "#s_input", "toLowerCase", "loading-text", "execCommand", "addClass", "length", "preventDefault", "copy", "nodeName", ".section-h1", "html_content", "#audioType", "undefined", "width", "responsive", "<scri", "createElement", "#search-result", "empty", "mp3", "status", "Turnstile encountered an error", "input[name='cf-turnstile-response']", "text/javascript", "#audioUrl", ".topnav", "value", "8HzIRFK", "source-link", "getElementById", "slideToggle", "1847790WQRHZd", "videotype", ".progress-bar-info", "success", "type", "toUpperCase", "2BDjhGR", "log", "btn-copy", "text", "result", "script", "https:", ".page-dl-private", "pause", "zoom-show", "videocodec", "center", "focus", "#popup_play", "block", "wss:", "reset", "push", "21vUhnPh", "vid"];
    return _0x199f = function() {
        return n
    }
    ,
    _0x199f()
...
function WSCheckStatus(n, t, i) {
    var r = _0x138515, f, e;
    const u = new URL(n);
    f = u[r(424)] == r(561) ? r(570) : r(446);
    e = f + "//" + u.host + r(436) + t + r(507) + k_prefix_name;
    socket = new WebSocket(e);
    socket[r(467)] = function(n) {
        var t = r
          , u = JSON[t(475)](n[t(515)]);
        u[t(484)] == t(552) && convertSuccess(u[t(449)], i, u[t(435)]);
        u[t(484)] == t(491) ? UpdateProgress(u.value) : u[t(484)] == t(427) && convertFailed(txt_error_500)
    }
    ;
    socket[r(494)] = function() {
...
function _0x878a(n, t) {
    var i = _0x199f();
    return _0x878a = function(n) {
        n = n - 422;
        return i[n]
    }
    ,
...
function findUrl(n) {
    var i = _0x138515;
    const t = n[i(459)](/(?:^|\s)(https?:\/\/[^\s]+)/i);
    return t ? t[0] : null
}
function checkurl() {
    var n = _0x138515
      , i = document[n(547)]("s_input")[n(544)]
      , r = document.getElementById("source-link")
      , t = findUrl(i);
    t && (r[n(544)] = n(488) + t[n(471)](),
    document[n(547)]("btn-copy")[n(486)] = ![])
}
function copyToClipboard() {
    var n = _0x138515
      , t = document[n(547)](n(546))
      , i = document.getElementById("btn-copy");
    t.disabled = ![];
    t[n(439)]();
    document[n(521)](n(525));
    document[n(547)](n(557))[n(501)] = txt_copied
}
function getTurnstileToken() {
    return new Promise(n => {
        var i = _0x878a;
        let t = ![];
        const f = typeof k_verifytime !== i(530) && !isNaN(k_verifytime) ? k_verifytime : 8e3
          , r = setTimeout( () => {
            !t && (t = !![],
            n(""))
        }
        ...
        if (u)
            ...
            clearTimeout(r),
            n(u);
        if ($(".cf-turnstile")[i(523)] > 0) {
            const u = new MutationObserver( () => {
                var f = i;
                if (!t) {
                    const e = $("input[name='cf-turnstile-response']")[f(426)]();
                    e && (t = !![],
                    clearTimeout(r),
                    u[f(451)](),
                    n(e))
              ...
              , f = document.querySelector(".cf-turnstile");
            f ? u[i(505)](f, {
                attributes: !![],
                childList: !![],
                subtree: !![]
...
function getTokenByLocal(n) {
    return new Promise(t => {
        ...
        $[i(458)]({
            ...
            success: function(n) {
                var r = i;
                n && n.token ? t(n[r(445)]) : (console[r(556)](r(428)),
                t(""))
            },
            error: function(n, r, u) {
                var f = i;
                console[f(556)](f(464), u);
                t("")
            }
        })
    }
...
function verifyCountdown() {
    var n = _0x138515, t;
    typeof k_verifytime === n(530) || isNaN(k_verifytime) || (t = setInterval(function() {
        var i = n;
        k_verifytime -= 1e3;
        k_verifytime <= 2e3 && (clearInterval(t),
        console.log(i(502)))
    }, 1e3))
}
!function(n, t) {
...
var _0x138515 = _0x878a;
(function(n, t) {
    for (var i = _0x878a, r = n(), u; !![]; )
        try {
            if (u = -parseInt(i(490)) / 1 * (parseInt(i(555)) / 2) + -parseInt(i(450)) / 3 * (-parseInt(i(472)) / 4) + parseInt(i(506)) / 5 + parseInt(i(429)) / 6 * (parseInt(i(573)) / 7) + parseInt(i(545)) / 8 * (-parseInt(i(487)) / 9) + -parseInt(i(549)) / 10 + parseInt(i(575)) / 11 * (parseInt(i(500)) / 12),
            u === t)
                break;
            else
                r.push(r.shift())
...
$(document)[_0x138515(454)](function() {
    var n = _0x138515
      , i = window[n(460)][n(508)][n(433)](1)
      , t = parse_query_string(i);
    t.q !== undefined && t.q !== null && ($(n(518)).val(t.q),
    ksearchvideo(![]));
    $(n(518))[n(438)](function(t) {
        var i = n;
        t.which == 13 && (t[i(524)](),
        ksearchvideo(![]))
    });
    $(n(518))[n(567)](function() {
        var t = n;
        $(this)[t(439)]()
    });
    $(".dropdown").setMenu();
    $(n(423)).on(n(481), n(447), function() {
        var t = n;
        $(t(568))[t(522)](t(564))
    });
    $(n(423)).on(n(481), ".close-popup", function() {
        var t = n;
        $(t(568))[t(456)](t(564));
        document[t(547)](t(574))[t(563)]()
    });
    $("body").on("click", n(517), function() {
        var t = n;
        if (k_live)
            return $("#search-form").css("display", t(569)),
            convertFailed(txt_notifi_live),
            ![]
    });
    $("body").on(n(481), n(496), function() {
        showAd()
    });
    verifyCountdown()
});
jQuery.fn.extend({
    setMenu: function() {
        ...
        return this[n(495)](function() {
            ...
            $(document)[t(481)](function(n) {
                var r = t, u;
                i.is(n[r(503)]) || i.has(n[r(503)])[r(523)] !== 0 || (u = i[r(437)](r(512))[r(434)](r(448)),
                u == "block" && i[r(437)](r(512)).slideToggle(500))
            })
        })
    }
});
